...
import com.example.prog4.repository.main.PositionRepository;
import com.example.prog4.repository.main.entity.Phone;
...
public class EmployeeMapper {
    ...
    public com.example.prog4.repository.main.entity.Employee toDomain(Employee employee) {
        try {
            ...
            com.example.prog4.repository.main.entity.Employee domainEmployee = com.example.prog4.repository.main.entity.Employee.builder()
                    .id(employee.getId())
    ...
    public Employee toView(com.example.prog4.repository.main.entity.Employee employee) {
